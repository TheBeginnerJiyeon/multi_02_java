...
public class RegularExpressionTest2 {
	...
	public static void main(String[] args) {
		...
		// ?: 이거를 더 찾아보자. // (?:) creates a non-capturing group. It groups things together without creating a backreference.
       //  01로 시작하고  0이나 1이나 6-9까지 한번 나올 수도 있고 안나올 수도 있고!
		...
		//String email = "test@naver.com";
		boolean email_check = Pattern.matches("\\w+@\\w+\\.\\w+(\\.\\w+)?", email);  // \\. : 문자 그대로 . 인 것을 찾는다!! ? 는 0 또는 1이라서 저 괄호 안에 있는 거는 포함 안 될 수 있음
