package com.multi.gameProject.generalUsers.model.userDTO;
...
public class UserDto {
	...
	public UserDto(String user_Id, String pw, int coin_Count, String name, int age, String email, String tel, Date singup_Date, char del_Acc, Date delete_Acc_Date) {
	...
	public UserDto(String user_Id, String pw, int coin_Count, String name, int age, String tel, String email, char del_Acc, Date delete_Acc_Date) {
		this.user_Id = user_Id;
		this.pw = pw;
		this.coin_Count = coin_Count;
		this.name = name;
